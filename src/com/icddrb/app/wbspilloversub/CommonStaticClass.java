package com.icddrb.app.wbspilloversub;
...
import com.icddrb.app.wbspilloversub.adapters.SpinAdapter;
import com.icddrb.app.wbspilloversub.db.DatabaseHelper;
import com.icddrb.app.wbspilloversub.questions.ParentActivity;

public class CommonStaticClass {

	public static String pName = "com.icddrb.app.wbspilloversub";
	...
	public static String getSkip(String column, String tablename,
		...
		if(CommonStaticClass.questionMap.get(
				CommonStaticClass.currentSLNo).getQvar().equalsIgnoreCase("qv")||CommonStaticClass.questionMap.get(
								CommonStaticClass.currentSLNo).getQvar().equalsIgnoreCase("q4019b")||
								CommonStaticClass.questionMap.get(
										CommonStaticClass.currentSLNo).getQvar().equalsIgnoreCase("v104_11")||
										CommonStaticClass.questionMap.get(
												CommonStaticClass.currentSLNo).getQvar().equalsIgnoreCase("qdia"))
		{
			sql = "Select " + column + " from " + tablename + " where dataid='"
					+ CommonStaticClass.dataId + "'";
		}
